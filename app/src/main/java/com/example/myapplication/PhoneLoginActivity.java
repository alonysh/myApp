...
public class PhoneLoginActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        InputUserPhoneNumber = (EditText) findViewById(R.id.phoneNumInput);
        InputUserVerificationCode = (EditText) findViewById(R.id.verifiCode);
        SendVerificationCodeButton = (Button) findViewById(R.id.SentVerifi);
        VerifyButton = (Button) findViewById(R.id.verifi);
...
public class PhoneLoginActivity extends AppCompatActivity {
    ...
    private Button SendVerifiBtn, VerifyBtn;
    private EditText InputPhnNum, InputVerifCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SendVerifiBtn = findViewById(R.id.SentVerifi);
        VerifyBtn = findViewById(R.id.verifi);
        InputPhnNum = findViewById(R.id.phoneNumInput);
        InputVerifCode = findViewById(R.id.verifiCode);
        loadingBar = new ProgressDialog(this);

        SendVerifiBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {


                String phoneNum = InputPhnNum.getText().toString();
                ...
                if (TextUtils.isEmpty(phoneNum)){
                    ...
                    loadingBar.setTitle("Phone verification");
                    loadingBar.setMessage("Please waite, while we are authenticating your phone");
                    loadingBar.setCanceledOnTouchOutside(false);
                    loadingBar.show();
        ...
        VerifyBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SendVerifiBtn.setVisibility(View.INVISIBLE);
                InputPhnNum.setVisibility(View.INVISIBLE);

                String verifiCode = InputVerifCode.getText().toString();
                ...
                if (TextUtils.isEmpty(verifiCode)) {
                    ...
                    loadingBar.setTitle("verification code ");
                    loadingBar.setMessage("Please waite, while we are verifying verification code");
                    loadingBar.setCanceledOnTouchOutside(false);
                    loadingBar.show();
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                ...
                SendVerifiBtn.setVisibility(View.VISIBLE);
                InputPhnNum.setVisibility(View.VISIBLE);

                VerifyBtn.setVisibility(View.INVISIBLE);
                InputVerifCode.setVisibility(View.INVISIBLE);
            ...
            public void onCodeSent(@NonNull String verificationId,
                ...
                InputVerifCode.setVisibility(View.VISIBLE);
